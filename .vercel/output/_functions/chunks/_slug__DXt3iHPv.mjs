...
import { a as getBlogPosts, p as paginatePosts, f as favicon, P as POSTS_PER_PAGE } from './favicon_lRGJ7iN7.mjs';
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const category = (await (await import('./favicon_lRGJ7iN7.mjs').then(n => n.b)).getBlogCategories()).find((c) => c.slug === slug) || { title: slug };
